...
import { createNode as markovCreateNode, createEdge as markovCreateEdge } from './markov-chain/defaults';
...
const registry: Record<string, DiagramTypeConfig> = {
  markov_chain: {
    ...
    sidebarItems: [
      { type: 'operational', label: 'Operational', group: 'States', colorClass: 'bg-green-500', borderClass: 'border-green-300' },
      { type: 'degraded', label: 'Degraded', group: 'States', colorClass: 'bg-yellow-500', borderClass: 'border-yellow-300' },
      { type: 'failed', label: 'Failed', group: 'States', colorClass: 'bg-red-500', borderClass: 'border-red-300' },
      { type: 'absorbing', label: 'Absorbing', group: 'States', colorClass: 'bg-gray-500', borderClass: 'border-gray-300' },
    ],
  ...
  fault_tree: {
    ...
    sidebarItems: [
      { type: 'and_gate', label: 'AND Gate', group: 'Gates', colorClass: 'bg-blue-500', borderClass: 'border-blue-300' },
      { type: 'or_gate', label: 'OR Gate', group: 'Gates', colorClass: 'bg-blue-400', borderClass: 'border-blue-300' },
      { type: 'not_gate', label: 'NOT Gate', group: 'Gates', colorClass: 'bg-blue-300', borderClass: 'border-blue-200' },
      { type: 'k_of_n_gate', label: 'K/N Gate', group: 'Gates', colorClass: 'bg-blue-600', borderClass: 'border-blue-400' },
      { type: 'xor_gate', label: 'XOR Gate', group: 'Gates', colorClass: 'bg-blue-700', borderClass: 'border-blue-500' },
      { type: 'basic_event', label: 'Basic Event', group: 'Events', colorClass: 'bg-green-500', borderClass: 'border-green-300' },
      { type: 'intermediate_event', label: 'Intermediate', group: 'Events', colorClass: 'bg-yellow-500', borderClass: 'border-yellow-300' },
      { type: 'top_event', label: 'Top Event', group: 'Events', colorClass: 'bg-red-500', borderClass: 'border-red-300' },
      { type: 'undeveloped_event', label: 'Undeveloped', group: 'Events', colorClass: 'bg-gray-400', borderClass: 'border-gray-300' },
    ],
  ...
  event_tree: {
    ...
    sidebarItems: [
      { type: 'initiating_event', label: 'Initiating Event', group: 'Events', colorClass: 'bg-orange-500', borderClass: 'border-orange-300' },
      { type: 'header', label: 'Header', group: 'Branch Points', colorClass: 'bg-blue-500', borderClass: 'border-blue-300' },
      { type: 'consequence', label: 'Consequence', group: 'Outcomes', colorClass: 'bg-green-500', borderClass: 'border-green-300' },
    ],
  ...
  reliability_block_diagram: {
    ...
    sidebarItems: [
      { type: 'block', label: 'Block', group: 'Components', colorClass: 'bg-blue-500', borderClass: 'border-blue-300' },
      { type: 'input_terminal', label: 'Input Terminal', group: 'Terminals', colorClass: 'bg-green-500', borderClass: 'border-green-300' },
      { type: 'output_terminal', label: 'Output Terminal', group: 'Terminals', colorClass: 'bg-red-500', borderClass: 'border-red-300' },
    ],
  ...
  bow_tie: {
    ...
    sidebarItems: [
      { type: 'threat', label: 'Threat', group: 'Threats', colorClass: 'bg-red-500', borderClass: 'border-red-300' },
      { type: 'preventive_barrier', label: 'Preventive Barrier', group: 'Barriers', colorClass: 'bg-blue-500', borderClass: 'border-blue-300' },
      { type: 'top_event', label: 'Top Event', group: 'Central Event', colorClass: 'bg-amber-500', borderClass: 'border-amber-300' },
      { type: 'mitigative_barrier', label: 'Mitigative Barrier', group: 'Barriers', colorClass: 'bg-green-500', borderClass: 'border-green-300' },
      { type: 'consequence', label: 'Consequence', group: 'Consequences', colorClass: 'bg-purple-500', borderClass: 'border-purple-300' },
    ],
