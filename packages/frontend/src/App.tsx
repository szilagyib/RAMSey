...
const ShareRedeemPage = lazy(() => import('./pages/ShareRedeemPage').then((m) => ({ default: m.ShareRedeemPage })));
        ...
        <BrowserRouter>
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route path="/projects/:projectId/diagrams/:diagramId" element={<ProtectedRoute><EditorPage /></ProtectedRoute>} />
            </Routes>
          </Suspense>
        </BrowserRouter>
      </AuthProvider>
